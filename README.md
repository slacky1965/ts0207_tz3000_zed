...
Если у вас датчик такой же, как на одной из двух фото ниже, то как его обновить описано **[здесь](README_TZ3000_k4ej3ww2_1M.md)**
...
> [!WARNING]
> Внимание!!! Но как всегда, все кроется в деталях. Чтобы система сработала даже без координатора, одно устройство из связки должно быть роутером (про то, что все эти устройства должны быть с резервным питание, я думаю и так понятно). Если вы объедините датчик, который является конечным устройством с другим устройством, которое тоже является конечным, то без координатора в сети это все работать все равно не будет. Поэтому исполнительное устройство, хоть одно из связки, обязательно должно быть роутером.
