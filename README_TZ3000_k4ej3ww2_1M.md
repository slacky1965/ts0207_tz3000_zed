...
В версии `_TZ3000_kstbkt6a` может быть различное исполнение датчика. Он может быть круглый, на батарейке `CR2032`, как на фото выше.

А может быть прямоугольным, с выносными контактами на проводе примерно 90 см длиной, на двух батарейках ААА, как на фото ниже.
